...
const VARIANTS: Array = [
	...
	# ソロモードセット(GameDesign.md 27章)の2枚。sand直系の色相はマナカーブ調整の回で
	# 使い切っているため、既存の色違いカードそのものを元にして散らす(58種化と同じ考え方)。
	["chime", "page", 0.12, 1.0, 0.18, 0.0],
	["ward", "shield", 0.30, 1.0, 0.18, 0.0],
]
