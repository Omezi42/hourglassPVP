...
const PLAY_CAPTION := (
	"実際に1局遊びながら、出す・ターンを終える・攻撃する・反転するを順に覚えます。" + "案内役のすなえるが、次に何をすればよいかを1つずつ教えてくれます。"
)
const READ_ITEMS: Array[Dictionary] = [
	{
		"label": "遊び方",
		"caption": "砂時計の読み方から勝ち方まで、実際の盤面を動かしながら順に説明します。",
	},
	{
		"label": "画面の見かた",
		"caption": "対局画面に出ているものが何を意味するのかを、盤面を光らせて示します。",
	},
	{
		"label": "キーワード辞書",
		"caption": "守護・硝子・貫通といった語の意味と、その能力を持つ砂時計を引けます。",
	},
]
