...
### AL-5: カード表の引き直し(**要承認・未着手**)

AL-1/AL-2 の測定により、**20種の多くが均衡総量から2以上ずれている**(とくに高コスト帯)
ことと、**GameDesign.md 6章の値段表(疲労レース時代の測定)が実装版エンジンと食い違う**
ことが分かった。守護と硝子は「大型ほど高い」ではなく逆の傾向だった。
`docs/BalanceReport_v5.md` 3〜4章の基準線と値段表から `docs/Hourglasses.md` の
コスト/総量を引き直し、GameDesign.md 6章の値段表を差し替える提案が必要。仕様変更のため未着手。
- [ ] **AM-5 UI**:対局画面(手札・山札・墓地・マナ・6枠の盤面)、デッキ編集(5枚→20枚)
- [ ] **AM-6 イラスト**:新規10種の生成(既存10種は流用可)
