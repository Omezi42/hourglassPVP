...
- [ ] **AM-1 `Architecture.md` を v5.0 向けに書き直す**。
  `HourglassData`(コスト/総量/キーワード/効果)・`GameState`(盤面6枠・マナ・手札・山札・墓地)・
  戦闘処理・反転処理が全面的に変わる
- [ ] **AM-2 データ層**:`CardData` の Resource 化とキーワードの enum 化
- [ ] **AM-3 ロジック層**:`GameState` の作り直し(山札・手札・マナ・戦闘・反転)
